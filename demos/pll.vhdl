...
-- Date        : Fri Oct 21 19:27:50 2022
-- Host        : Rievaulx running 64-bit major release  (build 9200)
-- Command     : write_vhdl -cell [get_cells pll_i] -force -mode funcsim -rename_top pll -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ {A:\Philip\Work\VHDL\scratch_vhdl\demos\pll.vhdl}
-- Design      : pll
...
entity \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pll__pll_clk_wiz\ is
  port (
  ...
  attribute ORIG_REF_NAME of \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pll__pll_clk_wiz\ : entity is "pll_clk_wiz";
end \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pll__pll_clk_wiz\;

architecture STRUCTURE of \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pll__pll_clk_wiz\ is
  signal clk_in_pll : STD_LOGIC;
  signal clk_out_pll : STD_LOGIC;
  signal clk_out_pll_en_clk : STD_LOGIC;
...
begin
inst: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pll__pll_clk_wiz\
     port map (
      clk_in => clk_in,
      clk_out => clk_out,
      locked => locked
